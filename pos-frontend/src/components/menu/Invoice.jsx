        ...
        <div ref={invoiceRef} className="p-4">
          ...
          <div className="mt-4 border-t pt-4 text-sm text-gray-700">
            <p>
              ...
              {Math.floor(new Date(orderInfo.orderDate ? orderInfo.orderDate : orderInfo.createdAt).getTime())}
            </p>
            <p>
            ...
            <p>
              <strong>Guests:</strong> {orderInfo.customerDetails.guest}
            </p>
          </div>
          ...
          <div className="mt-4 border-t pt-4 text-sm">
            <p>
              <strong>Subtotal:</strong> {formatRupiah(Number(orderInfo.bills.total))}
            </p>
            <p>
              <strong>Tax:</strong> {formatRupiah(0)}
            </p>
            <p className="text-md font-semibold">
              <strong>Grand Total:</strong> 
              {formatRupiah(Number(orderInfo.bills.total))}
            </p>
          </div>
