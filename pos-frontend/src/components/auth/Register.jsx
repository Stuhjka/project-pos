  ...
  return (
    <div>
      <form onSubmit={handleSubmit}>
        ...
        {/* --- ROLE SELECTION (INI YANG DIUBAH MEN) --- */}
        <div>
                ...
                {["Waiter", "Cashier", "Admin"].map((role) => {
                   return (
                     <button
                        ...
                        // 👇 LOGIKA WARNA DISINI: Kalau dipilih jadi Kuning, kalau enggak jadi Hitam
                        className={`px-4 py-3 w-full rounded-lg transition-all duration-300 
                        ${formData.role === role ? "bg-yellow-400 text-black font-bold" : "bg-[#1f1f1f] text-[#ababab]"}`}
                    >
                        {role}
                    </button>
                   )
